...
#     replace file name to um_000087.png form
    label_paths = {
            re.sub(r'_(lane|road)_', '_', os.path.basename(path)): path
            for path in glob(os.path.join(DATA_FOLDER, TRAIN_DIR, 'gt_image_2', '*_road_*.png'))}
    
    files = glob(os.path.join(DATA_FOLDER, TRAIN_DIR, 'image_2', '*.png'))
