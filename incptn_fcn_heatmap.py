...
#     Load the image
    ...
    label_paths = {
            ...
            for path in glob(os.path.join('/Users/windowsx/Desktop/Incptn_FCN/bdd100k/seg/color_labels/train', '*.png'))}

    files = glob(os.path.join('/Users/windowsx/Desktop/Incptn_FCN/bdd100k/seg/images/train', '*.*')) 
...
#        get gt image
        ...
        gt_bg = np.all(gt_image != np.array([128, 64, 128]), axis=2)
